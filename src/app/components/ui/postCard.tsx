...
export const PostCard: React.FC<postCardProps> = ({
    ...
    console.log(strapiImage(cover));
    return (
        <div className="shadow-lg bg-white p-4 min-h-[300px]  rounded-xl flex flex-col items-center justify-between">
            <div className="w-full h-3/4 mb-2">
                <div className="w-full aspect-video relative mb-4 overflow-hidden bg-[#f2f2f2] rounded-xl">
                    {cover && (
                        <Image
